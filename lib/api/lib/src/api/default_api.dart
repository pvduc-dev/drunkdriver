...
class DefaultApi {
  ...
  Future<Response<String>> driversControllerCreate({ 
...
_responseData = rawData == null ? null : deserialize<String, String>(rawData, 'String', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> driversControllerFindAll({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<String, String>(rawData, 'String', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> driversControllerFindOne({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<String, String>(rawData, 'String', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> driversControllerRemove({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<String, String>(rawData, 'String', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> driversControllerUpdate({ 
    required String id,
    required Object body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = rawData == null ? null : deserialize<String, String>(rawData, 'String', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Object>> usersControllerCreate({ 
    ...
    try {
_bodyData=jsonEncode(createProfileDto);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
