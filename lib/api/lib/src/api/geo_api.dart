...
class GeoApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DirectionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DirectionResponse>> geoControllerGetDistance({ 
    ...
    DirectionResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<DirectionResponse, DirectionResponse>(rawData, 'DirectionResponse', growable: true);
    ...
    return Response<DirectionResponse>(
      data: _responseData,
